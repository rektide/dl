...
export const FLOW_INPUT_ORIGIN = {
  input: "input",
  redirect: "redirect",
} as const;

export type FlowInputOrigin = (typeof FLOW_INPUT_ORIGIN)[keyof typeof FLOW_INPUT_ORIGIN];

export type FlowInputMetadataShape = {
  origin: FlowInputOrigin;
  fromProvider?: string;
  fromInput?: string;
  fromUrl?: string;
};

export type FlowInputMetadata = Readonly<FlowInputMetadataShape>;
