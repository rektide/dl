import type { FlowContext, FlowGoal, FlowPlugins, Repo } from "../flow/types.ts";
import type { InputEntry, InputStream } from "../input/types.ts";
import type { ProviderRegistry, ProviderRuntime } from "../provider/types.ts";
...
export type InputFanIn = (sources: ReadonlyArray<InputStream>, signal?: AbortSignal) => InputStream;
